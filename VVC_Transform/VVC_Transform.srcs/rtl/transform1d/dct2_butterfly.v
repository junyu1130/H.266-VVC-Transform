...
//output data
    ...
    output reg  signed  [IN_WIDTH + 1 : 0]  o_16    ,//32 18bit
...
//butterfly 
    reg  signed [IN_WIDTH - 1 : 0] butterfly64_in_u0[0 : 63], butterfly8_in_u1[0 : 7], butterfly4_in_u2[0 : 3], butterfly4_in_u3[0 : 3];
    reg  signed [IN_WIDTH     : 0] butterfly32_in_u0[0 : 31], butterfly4_in_u1[0 : 3];
    reg  signed [IN_WIDTH + 1 : 0] butterfly16_in_u0[0 : 15];
    reg  signed [IN_WIDTH + 2 : 0] butterfly8_in_u0[0 : 7];
    reg  signed [IN_WIDTH + 3 : 0] butterfly4_in_u0[0 : 3];
    wire signed [IN_WIDTH     : 0] butterfly64_out_u0[0 : 63], butterfly8_out_u1[0 : 7], butterfly4_out_u2[0 : 3], butterfly4_out_u3[0 : 3];
    wire signed [IN_WIDTH + 1 : 0] butterfly32_out_u0[0 : 31], butterfly4_out_u1[0 : 3];
    wire signed [IN_WIDTH + 2 : 0] butterfly16_out_u0[0 : 15];
...
always @(*) begin
    ...
    for (i = 0; i < 16; i = i + 1) begin
        butterfly16_in_u0[i] <= 0;
    end
    for (i = 0; i < 8; i = i + 1) begin
        butterfly8_in_u0[i] <= 0; butterfly8_in_u1[i] <= 0;
    end
