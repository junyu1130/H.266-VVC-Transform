...
always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
        ...
        o_valid <= i_valid_d1;
        o_0  <= ((sum0_0[0 ] + sum0_1[0 ]) + (+ sum0_2[0 ] + sum0_3[0 ])) + ((sum0_4[0 ] + sum0_5[0 ]) + (+ sum0_6[0 ] + sum0_7[0 ]));
        o_1  <= ((sum0_0[1 ] + sum0_1[1 ]) + (+ sum0_2[1 ] - sum0_3[1 ])) - ((sum0_4[1 ] + sum0_5[1 ]) + (+ sum0_6[1 ] + sum0_7[1 ]));
        o_2  <= ((sum0_0[2 ] + sum0_1[2 ]) + (- sum0_2[2 ] - sum0_3[2 ])) - ((sum0_4[2 ] - sum0_5[2 ]) + (- sum0_6[2 ] - sum0_7[2 ]));
        o_3  <= ((sum0_0[3 ] - sum0_1[3 ]) + (- sum0_2[3 ] - sum0_3[3 ])) + ((sum0_4[3 ] + sum0_5[3 ]) + (- sum0_6[3 ] - sum0_7[3 ]));
        o_4  <= ((sum0_0[4 ] - sum0_1[4 ]) + (- sum0_2[4 ] + sum0_3[4 ])) + ((sum0_4[4 ] - sum0_5[4 ]) + (+ sum0_6[4 ] + sum0_7[4 ]));
        o_5  <= ((sum0_0[5 ] - sum0_1[5 ]) + (+ sum0_2[5 ] + sum0_3[5 ])) - ((sum0_4[5 ] - sum0_5[5 ]) + (- sum0_6[5 ] + sum0_7[5 ]));
        o_6  <= ((sum0_0[6 ] - sum0_1[6 ]) + (+ sum0_2[6 ] - sum0_3[6 ])) - ((sum0_4[6 ] - sum0_5[6 ]) + (+ sum0_6[6 ] - sum0_7[6 ]));
        o_7  <= ((sum0_0[7 ] - sum0_1[7 ]) + (+ sum0_2[7 ] - sum0_3[7 ])) + ((sum0_4[7 ] - sum0_5[7 ]) + (+ sum0_6[7 ] - sum0_7[7 ]));
        o_8  <= 0;
        o_9  <= 0;
        o_10 <= 0;
        o_11 <= 0;
        ...
        o_6  <= ((sum0_0[6 ] - sum0_1[6 ]) + (+ sum0_2[6 ] - sum0_3[6 ])) - ((sum0_4[6 ] - sum0_5[6 ]) + (+ sum0_6[6 ] - sum0_7[6 ]));
        o_7  <= ((sum0_0[7 ] - sum0_1[7 ]) + (+ sum0_2[7 ] - sum0_3[7 ])) + ((sum0_4[7 ] - sum0_5[7 ]) + (+ sum0_6[7 ] - sum0_7[7 ]));
        o_8  <= ((sum0_0[8 ] - sum0_1[8 ]) + (+ sum0_2[8 ] - sum0_3[8 ])) - ((sum0_4[8 ] - sum0_5[8 ]) + (+ sum0_6[8 ] - sum0_7[8 ]));
        o_9  <= ((sum0_0[9 ] - sum0_1[9 ]) + (- sum0_2[9 ] + sum0_3[9 ])) - ((sum0_4[9 ] - sum0_5[9 ]) + (+ sum0_6[9 ] + sum0_7[9 ]));
        o_10 <= ((sum0_0[10] + sum0_1[10]) + (- sum0_2[10] + sum0_3[10])) + ((sum0_4[10] - sum0_5[10]) + (+ sum0_6[10] + sum0_7[10]));
        o_11 <= ((sum0_0[11] + sum0_1[11]) + (- sum0_2[11] - sum0_3[11])) + ((sum0_4[11] + sum0_5[11]) + (- sum0_6[11] + sum0_7[11]));
        o_12 <= ((sum0_0[12] + sum0_1[12]) + (+ sum0_2[12] - sum0_3[12])) - ((sum0_4[12] - sum0_5[12]) + (- sum0_6[12] + sum0_7[12]));
        o_13 <= ((sum0_0[13] + sum0_1[13]) + (+ sum0_2[13] - sum0_3[13])) - ((sum0_4[13] + sum0_5[13]) + (+ sum0_6[13] - sum0_7[13]));
        o_14 <= ((sum0_0[14] + sum0_1[14]) + (+ sum0_2[14] + sum0_3[14])) + ((sum0_4[14] + sum0_5[14]) + (- sum0_6[14] - sum0_7[14]));
        o_15 <= ((sum0_0[15] + sum0_1[15]) + (+ sum0_2[15] + sum0_3[15])) + ((sum0_4[15] + sum0_5[15]) + (+ sum0_6[15] + sum0_7[15]));
    end
end
