...
always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
        ...
        sum1_0[0 ] <= ((sum0_0[0 ] + sum0_1[0 ]) + (+ sum0_2[0 ] + sum0_3[0 ])) + ((sum0_4[0 ] + sum0_5[0 ]) + (+ sum0_6[0 ] + sum0_7[0 ])); 
        sum1_0[1 ] <= ((sum0_0[1 ] + sum0_1[1 ]) + (+ sum0_2[1 ] + sum0_3[1 ])) + ((sum0_4[1 ] + sum0_5[1 ]) + (- sum0_6[1 ] - sum0_7[1 ])); 
        sum1_0[2 ] <= ((sum0_0[2 ] + sum0_1[2 ]) + (+ sum0_2[2 ] - sum0_3[2 ])) - ((sum0_4[2 ] + sum0_5[2 ]) + (+ sum0_6[2 ] + sum0_7[2 ])); 
        sum1_0[3 ] <= ((sum0_0[3 ] + sum0_1[3 ]) + (+ sum0_2[3 ] - sum0_3[3 ])) - ((sum0_4[3 ] + sum0_5[3 ]) + (+ sum0_6[3 ] - sum0_7[3 ])); 
        sum1_0[4 ] <= ((sum0_0[4 ] + sum0_1[4 ]) + (- sum0_2[4 ] - sum0_3[4 ])) - ((sum0_4[4 ] + sum0_5[4 ]) + (- sum0_6[4 ] - sum0_7[4 ])); 
        sum1_0[5 ] <= ((sum0_0[5 ] + sum0_1[5 ]) + (- sum0_2[5 ] - sum0_3[5 ])) - ((sum0_4[5 ] - sum0_5[5 ]) + (- sum0_6[5 ] - sum0_7[5 ])); 
        sum1_0[6 ] <= ((sum0_0[6 ] - sum0_1[6 ]) + (- sum0_2[6 ] - sum0_3[6 ])) + ((sum0_4[6 ] + sum0_5[6 ]) + (- sum0_6[6 ] - sum0_7[6 ])); 
        sum1_0[7 ] <= ((sum0_0[7 ] - sum0_1[7 ]) + (- sum0_2[7 ] + sum0_3[7 ])) + ((sum0_4[7 ] + sum0_5[7 ]) + (- sum0_6[7 ] - sum0_7[7 ])); 
        sum1_0[8 ] <= ((sum0_0[8 ] - sum0_1[8 ]) + (- sum0_2[8 ] + sum0_3[8 ])) + ((sum0_4[8 ] - sum0_5[8 ]) + (- sum0_6[8 ] + sum0_7[8 ])); 
        sum1_0[9 ] <= ((sum0_0[9 ] - sum0_1[9 ]) + (- sum0_2[9 ] + sum0_3[9 ])) - ((sum0_4[9 ] + sum0_5[9 ]) + (- sum0_6[9 ] - sum0_7[9 ])); 
        sum1_0[10] <= ((sum0_0[10] - sum0_1[10]) + (- sum0_2[10] + sum0_3[10])) - ((sum0_4[10] + sum0_5[10]) + (- sum0_6[10] + sum0_7[10])); 
        sum1_0[11] <= ((sum0_0[11] - sum0_1[11]) + (+ sum0_2[11] + sum0_3[11])) - ((sum0_4[11] - sum0_5[11]) + (- sum0_6[11] + sum0_7[11])); 
        sum1_0[12] <= ((sum0_0[12] - sum0_1[12]) + (+ sum0_2[12] - sum0_3[12])) - ((sum0_4[12] - sum0_5[12]) + (+ sum0_6[12] - sum0_7[12])); 
        sum1_0[13] <= ((sum0_0[13] - sum0_1[13]) + (+ sum0_2[13] - sum0_3[13])) + ((sum0_4[13] + sum0_5[13]) + (- sum0_6[13] + sum0_7[13])); 
        sum1_0[14] <= ((sum0_0[14] - sum0_1[14]) + (+ sum0_2[14] - sum0_3[14])) + ((sum0_4[14] - sum0_5[14]) + (+ sum0_6[14] - sum0_7[14])); 
        sum1_0[15] <= ((sum0_0[15] - sum0_1[15]) + (+ sum0_2[15] - sum0_3[15])) + ((sum0_4[15] - sum0_5[15]) + (+ sum0_6[15] - sum0_7[15])); 

        sum1_1[0 ] <= + ((sum0_8[0 ] + sum0_9[0 ]) + (+ sum0_10[0 ] + sum0_11[0 ])) + ((sum0_12[0 ] + sum0_13[0 ]) + (+ sum0_14[0 ] + sum0_15[0 ]));
        sum1_1[1 ] <= - ((sum0_8[1 ] + sum0_9[1 ]) + (+ sum0_10[1 ] + sum0_11[1 ])) - ((sum0_12[1 ] + sum0_13[1 ]) + (+ sum0_14[1 ] + sum0_15[1 ]));
        sum1_1[2 ] <= - ((sum0_8[2 ] + sum0_9[2 ]) + (- sum0_10[2 ] - sum0_11[2 ])) + ((sum0_12[2 ] + sum0_13[2 ]) + (+ sum0_14[2 ] + sum0_15[2 ]));
        sum1_1[3 ] <= + ((sum0_8[3 ] + sum0_9[3 ]) + (+ sum0_10[3 ] + sum0_11[3 ])) - ((sum0_12[3 ] + sum0_13[3 ]) + (+ sum0_14[3 ] + sum0_15[3 ]));
        sum1_1[4 ] <= + ((sum0_8[4 ] - sum0_9[4 ]) + (- sum0_10[4 ] - sum0_11[4 ])) - ((sum0_12[4 ] - sum0_13[4 ]) + (- sum0_14[4 ] - sum0_15[4 ]));
        sum1_1[5 ] <= - ((sum0_8[5 ] + sum0_9[5 ]) + (- sum0_10[5 ] - sum0_11[5 ])) + ((sum0_12[5 ] - sum0_13[5 ]) + (- sum0_14[5 ] - sum0_15[5 ]));
        sum1_1[6 ] <= - ((sum0_8[6 ] - sum0_9[6 ]) + (- sum0_10[6 ] + sum0_11[6 ])) - ((sum0_12[6 ] + sum0_13[6 ]) + (- sum0_14[6 ] - sum0_15[6 ]));
        sum1_1[7 ] <= + ((sum0_8[7 ] + sum0_9[7 ]) + (- sum0_10[7 ] - sum0_11[7 ])) + ((sum0_12[7 ] + sum0_13[7 ]) + (- sum0_14[7 ] - sum0_15[7 ]));
        sum1_1[8 ] <= + ((sum0_8[8 ] - sum0_9[8 ]) + (- sum0_10[8 ] + sum0_11[8 ])) - ((sum0_12[8 ] + sum0_13[8 ]) + (- sum0_14[8 ] - sum0_15[8 ]));
        sum1_1[9 ] <= - ((sum0_8[9 ] + sum0_9[9 ]) + (- sum0_10[9 ] + sum0_11[9 ])) - ((sum0_12[9 ] - sum0_13[9 ]) + (- sum0_14[9 ] + sum0_15[9 ]));
        sum1_1[10] <= - ((sum0_8[10] - sum0_9[10]) + (+ sum0_10[10] + sum0_11[10])) + ((sum0_12[10] - sum0_13[10]) + (- sum0_14[10] + sum0_15[10]));
        sum1_1[11] <= + ((sum0_8[11] - sum0_9[11]) + (- sum0_10[11] + sum0_11[11])) - ((sum0_12[11] - sum0_13[11]) + (- sum0_14[11] + sum0_15[11]));
        sum1_1[12] <= + ((sum0_8[12] - sum0_9[12]) + (+ sum0_10[12] - sum0_11[12])) + ((sum0_12[12] + sum0_13[12]) + (- sum0_14[12] + sum0_15[12]));
        sum1_1[13] <= - ((sum0_8[13] - sum0_9[13]) + (+ sum0_10[13] + sum0_11[13])) + ((sum0_12[13] - sum0_13[13]) + (+ sum0_14[13] - sum0_15[13]));
        sum1_1[14] <= - ((sum0_8[14] - sum0_9[14]) + (+ sum0_10[14] - sum0_11[14])) - ((sum0_12[14] - sum0_13[14]) + (+ sum0_14[14] - sum0_15[14]));
        sum1_1[15] <= + ((sum0_8[15] - sum0_9[15]) + (+ sum0_10[15] - sum0_11[15])) + ((sum0_12[15] - sum0_13[15]) + (+ sum0_14[15] - sum0_15[15]));
    end
end
//stage 3
always @(posedge clk or negedge rst_n) begin
